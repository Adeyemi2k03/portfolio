  ...
  return (
    <div className="flex flex-col gap-10 py-4 max-w-xl">
      ...
      <div className="flex gap-3 flex-wrap">
        ...
        <a href="https://x.com/YourHandle" target="_blank" rel="noreferrer" className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium" style={{ background: 'var(--surface)', border: '1px solid var(--border)', color: 'var(--text)' }}>
          <span style={{ color: 'var(--accent)', fontWeight: 700, fontSize: 14 }}>𝕏</span> @YourHandle
        </a>
