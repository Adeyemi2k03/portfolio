...
const screenshots = [
  { src: '/screenshots/novaplex-1.png', caption: 'Hero banner with movie carousel' },
  { src: '/screenshots/novaplex-2.png', caption: 'Sign in / Create account modal' },
  { src: '/screenshots/novaplex-3.png', caption: 'Movie browsing grid with hover actions' },
  { src: '/screenshots/novaplex-4.png', caption: 'Movie detail modal with info & watch CTA' },
]
const stack = ['React', 'TypeScript', 'Tailwind CSS', 'Appwrite', 'TMDB API']
const highlights = [
  'Hero carousel with auto-sliding featured movies pulled from a live API',
  'Auth flow — sign in and create account via Appwrite',
  'Browse movies by category: Popular, Top Rated, Now Playing, Upcoming',
  'Hover-to-reveal watch & details actions on movie cards',
  'Movie detail modal with rating, runtime, genre, and synopsis',
  'Fully responsive across mobile, tablet, and desktop',
]

export default function ProjectNovaplex() {
    ...
    <div className="flex flex-col gap-10 py-4 max-w-4xl">
      ...
      <div>
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-xs" style={{ color: 'var(--muted)' }}>Movie Streaming App</span>
        </div>
        <h1 className="text-4xl md:text-5xl font-bold mb-3" style={{ color: 'var(--text)', letterSpacing: '-0.03em' }}>NovaPlex</h1>
        <p className="text-base leading-relaxed max-w-2xl" style={{ color: 'var(--muted)' }}>
          A Netflix-style movie streaming interface where users can browse, search, and explore movies and TV shows — with full authentication powered by Appwrite and live data from the TMDB API. Built to practice real-world front-end architecture on a product people actually recognise the shape of.
        </p>
      </div>

      <a href="https://novaplex.vercel.app/" target="_blank" rel="noreferrer" className="flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-semibold transition-opacity hover:opacity-80 w-fit" style={{ background: 'var(--accent)', color: 'var(--accent-text)' }}>
      ...
      <div>
        ...
        <div className="rounded-xl overflow-hidden" style={{ border: '1px solid var(--border)' }}>
          <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
            <iframe
              src="https://www.youtube.com/embed/sSr6WdmtY_8"
              title="NovaPlex Demo"
